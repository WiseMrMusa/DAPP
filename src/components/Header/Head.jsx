            ...
            <div className="fixed inset-x-0 top-0 z-30 flex h-14 items-center justify-between gap-12 px-4 transition left-72 backdrop-blur-sm  ring-1 ring-zinc-900/10">
                ...
                <div className="block max-w-md flex-auto">
                    ...
                    >
                        ...
                        <kbd className="ml-auto text-2xs text-zinc-400 "><kbd class="font-sans">⌘</kbd><kbd class="font-sans">K</kbd></kbd>
                    </button>
                </div>
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className="h-5 w-5 stroke-zinc-900 "><path d="M12.5 10a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"></path><path stroke-linecap="round" d="M10 5.5v-1M13.182 6.818l.707-.707M14.5 10h1M13.182 13.182l.707.707M10 15.5v-1M6.11 13.889l.708-.707M4.5 10h1M6.11 6.111l.708.707"></path></svg>
